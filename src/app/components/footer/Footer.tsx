...
export function Footer() {
    return (
        <footer className="m-auto flex items-center justify-center p-4 min-[650px]:p-8">
            <div className="items-evenly grid grid-cols-[1fr_2.75fr] grid-rows-[max-content_max-content_max-content] gap-x-1 gap-y-1 text-xs min-[650px]:grid-cols-[1fr_360px] min-[650px]:gap-x-4 min-[650px]:text-lg">
                <Image
                    src={scContraLogo}
                ...
                <p className="flex flex-col justify-center">
                    Dance Inclusion of Santa Cruz County
                    <br />
                    12705 Highway 9<br />
                ...
                <p className="flex flex-col justify-center font-title italic">
                    Copyright &copy; 2024 Dance Inclusion of Santa Cruz County,
                    all rights reserved.
                </p>
            </div>
        </footer>
